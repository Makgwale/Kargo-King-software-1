...
{
    public partial class LiveOrderPage : Form
    {
       ...
       // DataTable dataTable;
        ...
        void FillCombo()
        {
            ...
            string query = "Select ORDER_ID from ONLINE_ORDERS where GARAGE_NAME ='"+ txtBxGarage.Text +"' and  ORDER_DATE = '"+ dateTimePicker1.Text+ "' ";
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            VALUES ('" + txtBxGarage.Text + "','" + cmbBxType.Text + "', '"+txtBxNumOfVehicle.Text+"', '"+txtBxStatus.Text+"', '"+txtBxCity.Text+"', '"+txtBxDepature.Text+"', '"+txtBxDestination.Text+"', '"+dateTimePicker1.Text+"', '"+txtBxUsername+"')", con);
            con.Open();
            cmd.ExecuteNonQuery();
            con.Close();
        ...
        {
          string query = "update ONLINE_ORDERS set [GARAGE_NAME] = '"+txtBxGarage.Text +"', VEHICLE_TYPE = '"+cmbBxType.Text+"',NO_OF_VEHICLES = '"+txtBxNumOfVehicle.Text+"', VEHICLE_STATUS = '"+txtBxStatus.Text+"',CITY = '"+txtBxCity.Text+"', DEPARTURE_ADDRESS = '"+txtBxDepature.Text+"', [DESTINATION_ADDRESS] = '"+txtBxDestination.Text+"', ORDER_DATE = '"+dateTimePicker1.Value.ToString()+"', CLIENT_USERNAME = '"+txtBxUsername.Text+"' where ORDER_ID="+cmbBxOrderID.SelectedItem+" ";
