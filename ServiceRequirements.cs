...
{
    public partial class ServiceRequirements : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand(@"INSERT INTO SERVICE_REQUIREMENTS(VEHICLE_REGISTRATION,SERVICE_TYPE, APPOINTMENT_DATE,  APPOINTMENT_TIME , SERVICE_TO_BE_PERFORMED, VEHICLE_TYPE,VEHICLE_MANUFACTURER,ENGINE_SIZE, CURRENT_ODOMETER_READING, NEXT_SERVICE_ODOMETER_READING) 
            VALUES ('" + cmbBxReg.Text + "','"+txtBxServiceType.Text+"','" + dateTimePicker1.Text + "', '" + txtBxTime.Text + "', '" + rchTxtBxService.Text + "', '" + txtBxType.Text + "', '" + txtBxManufacturer.Text + "','" + txtBxEngine.Text + "', '" + txtBxCurrent.Text + "', '" + rchTxtBxService.Text + "')", con);
            con.Open();
            ...
            try
            {
                ...
                if (cmd.ExecuteNonQuery() > 0)/*(ProgrammingWizards TV, 2016)*/
                {
                    ...
                    MessageBox.Show("Service Requirements Successfully Saved, \nTo make change edit the changes in the textboxes \nThen click Update...");
                }
